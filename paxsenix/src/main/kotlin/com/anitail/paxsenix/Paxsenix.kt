package com.anitail.paxsenix

import android.content.Context
import com.anitail.music.betterlyrics.TTMLParser
import com.anitail.paxsenix.models.AppleMusicSearchResponse
import com.anitail.paxsenix.models.LyricsResponse

import com.anitail.paxsenix.models.SearchResult
        ...
        synchronized(this) {
            ...
            client = HttpClient(Android) {
                ...
                defaultRequest {
                    ...
                    header("User-Agent", "AniTail/$appVersion")
                }
