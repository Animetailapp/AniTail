...
/**
 * Generic ChipsRow component - identical to Android version.
 * Shows a horizontal scrollable row of filter chips.
 */
@Composable
fun <E> ChipsRow(
                ...
                label = {
                    Text(
                        text = when (selectedOption) {
                            OptionStats.WEEKS -> stringResource("weeks")
                            OptionStats.MONTHS -> stringResource("months")
                            OptionStats.YEARS -> stringResource("years")
                            OptionStats.CONTINUOUS -> stringResource("continuous")
                        },
                    )
                },
                trailingIcon = {
